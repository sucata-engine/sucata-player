...
Remove-Item -Recurse -Force -ErrorAction SilentlyContinue luajit
...
New-Item -ItemType Directory -Name luajit
Move-Item .\luajit-odin\luajit.odin .\luajit
Remove-Item -Recurse -Force luajit-odin
